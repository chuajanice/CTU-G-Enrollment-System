...
?>
  ...
  dropdown.addEventListener('change', function() {
	...
	function confirmClear() {
		if (confirm("WARNING: This will permanently delete ALL BIT-CT 4th-year students.\n\nAre you sure?")) {
			window.location.href = "clear_bit-ct4.php";
		}
	}
	</script>
</body>
