...
<head>
  ...
  <title>BTLED-ICT 4 - Students</title>
...
<script>
  ...
  dropdown.addEventListener('change', function() {
	...
	function confirmClear() {
		if (confirm("WARNING: This will permanently delete ALL BTLED-ICT 4th-year students.\n\nAre you sure?")) {
			window.location.href = "clear_btled-ict4.php";
		}
	}
	</script>	
