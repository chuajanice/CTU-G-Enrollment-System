...
<body>
  <div class="dashboard">
    <header class="admin-header">
      <div class="admin-profile">
        ...
        <h3>BSIT - Irregulars</h3>
      </div>

      <div class="icons">
        <button onclick="window.location.href='BSIT.html'" title="Back">
    ...
    $i++;
              ...
              echo "<tr><td colspan='9'>No Irregular BSIT students found.</td></tr>";
          }
  ...
  dropdown.addEventListener('change', function() {
	...
	function confirmClear() {
		if (confirm("WARNING: This will permanently delete ALL BIT-CT 1st-year students.\n\nAre you sure?")) {
			window.location.href = "clear_bit-ct1.php";
		}
	}
	</script>
</body>
