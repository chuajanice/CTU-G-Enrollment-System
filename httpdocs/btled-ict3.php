...
<head>
  ...
  <title>BTLED-ICT 3 - Students</title>
...
<body>
  ...
  dropdown.addEventListener('change', function() {
	...
	function confirmClear() {
		if (confirm("WARNING: This will permanently delete ALL BTLED-ICT 3rd-year students.\n\nAre you sure?")) {
			window.location.href = "clear_btled-ict3.php";
		}
	}
	</script>
</body>
