...
<head>
  ...
  <title>BTLED-ICT 2 - Students</title>
...
<body>
  ...
  dropdown.addEventListener('change', function() {
	...
	function confirmClear() {
		if (confirm("WARNING: This will permanently delete ALL BTLED-ICT 2nd-year students.\n\nAre you sure?")) {
			window.location.href = "clear_btled-ict2.php";
		}
	}
	</script>
</body>
