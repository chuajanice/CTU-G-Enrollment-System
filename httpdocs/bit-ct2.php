...
?>
  ...
  dropdown.addEventListener('change', function() {
	...
	function confirmClear() {
		if (confirm("WARNING: This will permanently delete ALL BIT-CT 2nd-year students.\n\nAre you sure?")) {
			window.location.href = "clear_bit-ct2.php";
		}
	}
	</script>
</body>
