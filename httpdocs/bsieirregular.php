...
$program = 'BSIE'; // Changed from 'BSIT' to 'BIT-CT'
...
<head>
  ...
  <title>BSIE Irregular Students</title>
...
<body>
  <div class="dashboard">
    ...
    $i++;
              ...
              echo "<tr><td colspan='9'>No Irregular BSIE students found.</td></tr>";
          }
  ...
  dropdown.addEventListener('change', function() {
	...
	function confirmClear() {
		if (confirm("WARNING: This will permanently delete ALL BSIE Irregular students.\n\nAre you sure?")) {
			window.location.href = "clear_bsieirregular.php";
		}
	}
	</script>
</body>
