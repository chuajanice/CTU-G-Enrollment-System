...
?>
  ...
  dropdown.addEventListener('change', function() {
	...
	function confirmClear() {
		if (confirm("WARNING: This will permanently delete ALL BIT-CT 3rd-year students.\n\nAre you sure?")) {
			window.location.href = "clear_bit-ct3.php";
		}
	}
	</script>
</body>
