...
$program = 'BIT-CT'; // Changed from 'BSIT' to 'BIT-CT'
...
<head>
  ...
  <title>BIT-CT Irregular Students</title>
...
<body>
  <div class="dashboard">
    <header class="admin-header">
      <div class="admin-profile">
        ...
        <h3>BIT-CT Irregular</h3>
      </div>
      <div class="icons">
        <button onclick="window.location.href='BIT-CT.html'" title="Back">
    ...
    $i++;
              ...
              echo "<tr><td colspan='9'>No Irregular BIT-CT students found.</td></tr>";
          }
  ...
  dropdown.addEventListener('change', function() {
	...
	function confirmClear() {
		if (confirm("WARNING: This will permanently delete ALL BIT-CT Irregular students.\n\nAre you sure?")) {
			window.location.href = "clear_bit-ctirregular.php";
		}
	}
	</script>
</body>
