...
<head>
  ...
  <title>BTLED-ICT 1 - Students</title>
...
<body>
  ...
  dropdown.addEventListener('change', function() {
	...
	function confirmClear() {
		if (confirm("WARNING: This will permanently delete ALL BTLED-ICT 1st-year students.\n\nAre you sure?")) {
			window.location.href = "clear_btled-ict1.php";
		}
	}
	</script>
</body>
