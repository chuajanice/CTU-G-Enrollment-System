...
$program = 'BTLED-ICT'; // Changed from 'BSIT' to 'BIT-CT'
...
<head>
  ...
  <title>BTLED-ICT Irregular Students</title>
...
<body>
  <div class="dashboard">
    <header class="admin-header">
      <div class="admin-profile">
        ...
        <h3>BTLED-ICT Irregular</h3>
      </div>
      <div class="icons">
        <button onclick="window.location.href='btled-ict.html'" title="Back">
    ...
    $i++;
              ...
              echo "<tr><td colspan='9'>No Irregular BTLED-ICT students found.</td></tr>";
          }
  ...
  dropdown.addEventListener('change', function() {
	...
	function confirmClear() {
		if (confirm("WARNING: This will permanently delete ALL BTLED-ICT Irregular students.\n\nAre you sure?")) {
			window.location.href = "clear_btled-ictirregular.php";
		}
	}
	</script>
</body>
